...
from openeye import omega, oechem
import quacpac
...
from orionplatform.ports import RecordInputPort, RecordOuputPort
...
class AM1BCCCharge(RecordPortsMixin, ComputeCube):
    ...
    max_search_time = FloatParameter(
        'max_search_time',
        default=2.0,
        help_text = 'Maiximum search time.')

    energy_window = FloatParameter(
        'energy_window',
        default=15,
